...
const SIGNUP = { email: 'dueno@negocio.com', password: 'pw1234567890', businessName: 'Tapicería Sol', industry: 'tapiceria', market: 'MX', acceptedTerms: true, acceptedWhatsappRisk: true };
